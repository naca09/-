	...
	<div class="cart-items">
		<div class="container">
				...
				<div class="cart-header col-md-6">
					<div class="cart-sec simpleCart_shelfItem">
						...
						<div class="cart-item-info">
							...
							<h3><span>Unit Price: $ ${item.value.price}</span></h3>
							<h3><span>Quantity: ${item.value.amount}</span></h3>
							<a class="btn btn-info" href="javascript:buy(${item.key});">Increase</a>
							<a class="btn btn-warning" href="javascript:lessen(${item.key});">Reduce</a>
			...
			<div class="cart-header col-md-12">
				...
				<a class="btn btn-success btn-lg" style="margin-left:74%" href="${pageContext.request.contextPath }/order_submit">Submit Order</a>
			</div>
