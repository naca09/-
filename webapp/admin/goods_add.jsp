...
<jsp:include page="/admin/header.jsp"></jsp:include>
	...
	<form class="form-horizontal" action="${pageContext.request.contextPath }/admin/goods_add" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label for="input_name" class="col-sm-1 control-label">Introduce</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<label for="input_file" class="col-sm-1 control-label">Image 1</label> 
			<div class="col-sm-6">
				<input type="file" name="cover"  id="input_file" required="required">Size: 500 * 500
			</div>
		</div>
		<div class="form-group">
			<label for="input_file" class="col-sm-1 control-label">Image 2</label> 
			<div class="col-sm-6">
				<input type="file" name="image1"  id="input_file" required="required">Size: 500 * 500
			</div>
		</div>
		<div class="form-group">
			<label for="input_file" class="col-sm-1 control-label">Image 3</label> 
			<div class="col-sm-6">
				<input type="file" name="image2"  id="input_file" required="required">Size: 500 * 500
			</div>
		</div>
		<div class="form-group">
			<label for="select_topic" class="col-sm-1 control-label">Type</label>
			<div class="col-sm-6">
